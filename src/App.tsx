      ...
      <div className="mx-auto rounded-xl w-[95%] lg:w-[80%] -mt-12 bg-white py-3 px-2 md:py-10 md:px-8 flex items-center justify-between" style={boxStyle}>
        <div className="flex items-center">
          <div className="flex items-center justify-center flex-col md:flex-row md:mr-2 lg:mr-5">
            ...
            <p className="font-light w-12 md:w-24 text-[10px] md:text-sm">Planned Projects</p>
          </div>
          <svg
            width="12"
            height="29"
        ...
        <div className="flex items-center">
          <div className="items-center justify-center flex-col md:flex-row flex md:mr-2 lg:mr-5">
            <h1 className="text-[#03012C] text-sm md:text-2xl font-semibold md:mr-2 lg:mr-3">345</h1>
            <p className="font-light w-12 md:w-24 text-[10px] md:text-sm">Awarded Projects</p>
          </div>
          <svg
            width="12"
            height="29"
        ...
        <div className="flex items-center">
          <div className="flex items-center justify-center flex-col md:flex-row md:mr-2 lg:mr-5">
            <h1 className="text-[#03012C] text-sm md:text-2xl font-semibold md:mr-2 lg:mr-3">#1M+</h1>
            <p className="font-light text-[10px] w-12 md:w-24 md:text-sm">Total Sum Projects</p>
          </div>
          <svg
            width="12"
            height="29"
        ...
        <div className="flex items-center">
          <div className="items-center justify-center flex-col md:flex-row flex md:mr-2 lg:mr-5">
            <h1 className="text-[#03012C] text-sm md:text-2xl font-semibold md:mr-2 lg:mr-3">2943</h1>
            <p className="font-light md:w-24 text-[10px] w-12 md:text-sm">Published  Projects</p>
          </div>
          <svg
            width="12"
            height="29"
